...
export default function SecondstepGetfree() {
    ...
    return (
        <div className={css.GetfreeEstimate_content_value}>
            ...
            <p className={css.radio_button_Heading}>Your requirements for 1 BHK*</p>
            <div className={css.Count_content_component}>
                ...
                <div><Counter count={bedroom} onCountChange={handleCountChange} countName="Bedroom"/></div>
