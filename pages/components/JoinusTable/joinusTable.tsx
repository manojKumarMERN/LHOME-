...
//       setSelectedDepartment(null);
//     }else if (selectedtitle !== null) {
//       // If 'selectedtitle' has a value, set 'selectedLocation' and 'selectedDepartment' to null
//       setSelectedLocation(null);
//       setSelectedDepartment(null);
//     } else if (selectedLocation !== null) {
//       // If 'selectedLocation' has a value, set 'selectedtitle' and 'selectedDepartment' to null
//       setSelectedtitle(null);
//       setSelectedDepartment(null);
//     } 
//   }, [selectedtitle, selectedLocation]);
