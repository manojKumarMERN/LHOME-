                ...
                <div id="formentry" className={`flex  gap-6 ${css.inputbox}`}>
                    <div className={`relative h-full w-full min-w-[200px] ${css.marginmove_5}`}>
                        <input
                            ...
                            className={`peer h-full w-full border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-Montserrat text-16px font-normal placeholder-gray-700 placeholder-opacity-40  outline outline-0 transition-all placeholder-shown:border-blue-gray-800 focus:border-pink-500 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 ${css.forminput}`}/>
