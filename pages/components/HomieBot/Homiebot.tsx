    ...
    (function (d, m) {
      var kommunicateSettings = {
        ...
        onInit: function () {
          ...
          customBox.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 1440 320"><path fill="#1E50AC" fill-opacity="1" d="M0,224L80,224C160,224,320,224,480,197.3C640,171,800,117,960,106.7C1120,96,1280,128,1360,144L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>';
